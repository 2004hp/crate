...
The ``ThreadPools`` MXBean exposes statistic information about the used thread
...
| Name                  | Description                                             |
+=======================+=========================================================+
| ``Generic``           | Thread pool statistic of the ``generic`` thread pool.   |
+-----------------------+---------------------------------------------------------+
| ``Search``            | Thread pool statistics of the ``search`` thread pool    |
|                       | used by read queries on user generated tables.          |
+-----------------------+---------------------------------------------------------+
...
|                       | repository infos, allocations, etc.                     |
+-----------------------+---------------------------------------------------------+
...
|                       | used for fsyncing to disk and engine segment merges.    |
+-----------------------+---------------------------------------------------------+
| ``Refresh``           | Thread pool statistics of the ``refresh`` thread pool   |
|                       | used for refreshing document readers.                   |
+-----------------------+---------------------------------------------------------+
...
|                       | pool used when running an ``optimize`` query.           |
+-----------------------+---------------------------------------------------------+
| ``Listener``          | Thread pool statistics of the ``listener`` thread pool  |
|                       | used on client nodes for ansyncronous result listeners. |
+-----------------------+---------------------------------------------------------+
...
of each thread pool with following attributes:
...
+---------------------+-----------------------------------------------------+
| ``queueSize``       | The current number of threads in the queue.         |
+---------------------+-----------------------------------------------------+
